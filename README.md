...
```bash
npm install @stdlib/assert-has-map-support
```
...
```bash
npm install -g @stdlib/assert-has-map-support
```
...
[test-image]: https://github.com/stdlib-js/assert-has-map-support/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-has-map-support/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/assert-has-map-support
